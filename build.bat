...
set LIBRARY_DIRECTORIES=srclibs\pge libraries\libminiDNN libraries\libeigen
set LIBRARY_NAMES=setupapi comdlg32 user32 gdi32 gdiplus opengl32 Shlwapi dwmapi stdc++fs
